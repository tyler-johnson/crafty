...
// eventful
Templates.prototype = Object.create(EventEmitter.prototype);
...
Templates.prototype.name = function(file) {
	...
	if (ext === this.options.extension) file = file.substr(0, file.length - ext.length);
	
	if (this.base != null && file.substr(0, this.base.length) === this.base) {
		file = file.substr(this.base.length);
